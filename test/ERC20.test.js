...
const ERC20Mock = artifacts.require('eDIVI');
const ERC20DecimalsMock = artifacts.require('eDIVI');
...
contract('ERC20', function (accounts) {
  ...
  const initialSupply = new BN(process.env.INITIAL_AMOUNT);

  beforeEach(async function () {
    this.token = await ERC20Mock.new(name, symbol, decimals, initialSupply, initialHolder);
  });
  ...
  describe('set decimals', function () {
    ...
    it('can set decimals during construction', async function () {
      const token = await ERC20DecimalsMock.new(name, symbol, decimals, initialSupply, initialHolder);

...
const INTERFACES = {
  ...
  IDivision: [
    'hashProposal(address[],bytes[],bytes32)',
    'proposalDeadline(uint256)',
    'setVotingPeriod(uint256)',
    'submitProposal(address[],bytes[],string)',
    'voteForProposal(address[],bytes[],string)',
    'executeProposal(address[],bytes[],string)',
  ],
};
...
function shouldSupportInterfaces (interfaces = []) {
  describe('Contract interface', function () {
    beforeEach(function () {
      this.contractUnderTest = this.accessControl;
    });
